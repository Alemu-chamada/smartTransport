  ...
  return (
    <div className="min-h-screen relative flex flex-col items-center justify-center overflow-hidden"
      ...
      <motion.div className="absolute top-1/4 left-1/4 w-80 sm:w-[480px] h-80 sm:h-[480px] rounded-full blur-3xl z-0 pointer-events-none"
        style={{ background: "radial-gradient(circle, rgba(255,65,3,0.18) 0%, transparent 70%)" }}
      ...
      <motion.div className="absolute bottom-1/4 right-1/4 w-56 sm:w-80 h-56 sm:h-80 rounded-full blur-3xl z-0 pointer-events-none"
        style={{ background: "radial-gradient(circle, rgba(33,241,168,0.15) 0%, transparent 70%)" }}
      ...
      {[...Array(5)].map((_, i) => (
        <motion.div key={i}
          ...
          style={{ width: `${6 + i * 2}px`, height: `${6 + i * 2}px`,
                   ...
                   backgroundColor: i % 2 === 0 ? "rgba(255,65,3,0.3)" : "rgba(33,241,168,0.2)" }}
          ...
          <Link to="/" className="flex flex-col items-center gap-3 group">
            ...
            <div className="text-center">
              <div className="text-white font-black text-xl sm:text-2xl leading-tight">
                Smart<span style={{ color: "#21F1A8" }}>Transport</span>
              </div>
              <div className="text-xs mt-0.5 font-bold uppercase tracking-widest"
                style={{ color: "rgba(255,255,255,0.35)" }}>Management System</div>
            </div>
          </Link>
